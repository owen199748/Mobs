...
public class PointSpawn extends Spawn {
	...
	public PointSpawn(ConfigurationSection cfg) {
		...
		o = new Loc(cfg.getConfigurationSection("center").getString("WORLD"),
				cfg.getConfigurationSection("center").getInt("X"), cfg
						.getConfigurationSection("center").getInt("Y"), cfg
						.getConfigurationSection("center").getInt("Z"));
		one = cfg.getInt("one");
		Pmobcreates.add(this);
	}
	...
	public String getSee() {
		...
		String s1 = "刷新点位置:" + p.getX() + "," + p.getY() + "," + p.getZ() + "|"
				+ p.getWorld();
		String s2 = "怪物活动范围的中心:" + o.getX() + "," + o.getY() + "," + o.getZ()
				+ "|" + o.getWorld();
